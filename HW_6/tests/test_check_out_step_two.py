...
from HW_6.pages.check_out_step_two import CheckOutStepTwo
...
def test_check_6_items(driver):
    ...
    assert "checkout-step-two.html" in login_page.get_current_url(), ('Not...')
    check_out_step_two = CheckOutStepTwo(driver)
